...
function AdminConsole() { return <><StaffSessionBar label="BUREAU ADMINISTRATION" /><Admin /></> }
function AppRoutes() { const location = useLocation(); const full = location.pathname === '/wall' || location.pathname === '/admin/qr-print'; return <Layout full={full}><Routes><Route path="/" element={<Home />} /><Route path="/register" element={<Register />} /><Route path="/access/:token" element={<Access />} /><Route path="/upload" element={<Upload />} /><Route path="/wall" element={<Wall />} /><Route path="/agent/:id" element={<AgentFile />} /><Route path="/agents" element={<Agents />} /><Route path="/staff/login" element={<StaffLogin />} /><Route path="/staff" element={<StaffGate roles={['OWNER','ADMIN','STAFF']}><Staff /></StaffGate>} /><Route path="/admin" element={<StaffGate roles={['OWNER','ADMIN']}><AdminConsole /></StaffGate>} /><Route path="/admin/staff" element={<StaffGate roles={['OWNER']}><StaffManagement /></StaffGate>} /><Route path="/admin/qr-print" element={<StaffGate roles={['OWNER','ADMIN']}><QrPrint /></StaffGate>} /><Route path="*" element={<Home />} /></Routes></Layout> }
